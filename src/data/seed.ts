...
// Nombres que deben coincidir con la columna `full_name` de la tabla `profiles`
const DEFAULT_TECHNICIAN_1 = 'Alex Rodríguez'
const DEFAULT_TECHNICIAN_2 = 'Laura Gómez'
...
const orders: RepairOrder[] = [
  order({
    ...
    reportedProblem: 'No enciende después de una caída. El equipo vibra al conectarlo.', diagnosis: 'Daño en línea de alimentación principal. Requiere trabajo de microelectrónica.', partsUsed: 'IC de carga PMIC', technician: DEFAULT_TECHNICIAN_1, status: 'En reparación', estimatedTotal: 280000,
    ...
    movements: [
      ...
      { id: 'ord-1-mov-3', description: 'Estado actualizado: Recibido → En reparación', createdAt: at(0, 15, 20), actor: DEFAULT_TECHNICIAN_1 },
    ],
  ...
  order({
    ...
    reportedProblem: 'La pantalla parpadea y presenta líneas verticales.', diagnosis: 'Falso contacto en conector de pantalla.', workPerformed: 'Microsoldadura y calibración de pantalla.', partsUsed: 'Flex de pantalla', technician: DEFAULT_TECHNICIAN_2, status: 'Listo para entregar', estimatedTotal: 450000,
    ...
    movements: [
      ...
      { id: 'ord-2-mov-2', description: 'Estado actualizado: En reparación → Listo para entregar', createdAt: at(0, 15, 30), actor: DEFAULT_TECHNICIAN_2 },
  ...
  order({
    ...
    reportedProblem: 'No reconoce la red móvil ni el chip SIM.', technician: DEFAULT_TECHNICIAN_1, status: 'En diagnóstico', estimatedTotal: 180000, payments: [],
  }),
  order({
    ...
    reportedProblem: 'La cámara principal no enfoca y se reinicia al abrirla.', diagnosis: 'Módulo de cámara con corto interno.', technician: DEFAULT_TECHNICIAN_2, status: 'Esperando repuestos', estimatedTotal: 320000,
  ...
  order({
    ...
    reportedProblem: 'Batería se descarga muy rápido.', diagnosis: 'Capacidad de batería al 72%.', workPerformed: 'Cambio de batería y prueba de consumo.', partsUsed: 'Batería iPhone 11', technician: DEFAULT_TECHNICIAN_1, status: 'Entregado', estimatedTotal: 260000,
  ...
  order({
    ...
    reportedProblem: 'No carga de forma estable.', diagnosis: 'Conector USB-C sulfatado.', workPerformed: 'Limpieza ultrasónica y cambio de conector.', technician: DEFAULT_TECHNICIAN_2, status: 'Reparado', estimatedTotal: 210000,
    payments: [],
  }),
  order({
    ...
    reportedProblem: 'Se mojó y no enciende.', technician: DEFAULT_TECHNICIAN_1, status: 'Recibido', estimatedTotal: 0, payments: [],
  }),
  order({
    ...
    reportedProblem: 'Pantalla rota por golpe.', diagnosis: 'Módulo completo con daño físico.', technician: DEFAULT_TECHNICIAN_2, status: 'Cancelado', estimatedTotal: 340000, payments: [],
  }),
]
